...
@section('pageTitle', 'SerialNumber - Create')
@section('head')
...
<section class="content">
    <div class="container-fluid">
        ...
        <div class="card-body">
            <form role="form" action="{{route('SerialNumber.store')}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                <!-- <div class="card-body"> -->
                    ...
                    <div class="col-lg-4">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <label for="date" class="col-sm-3 col-form-label">date</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="date" id="date" value="{{old('date')}}" placeholder="date" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Invoice" class="col-sm-3 col-form-label">Invoice</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="invoice" id="invoice" value="{{old('invoice')}}" placeholder="Invoice Number" />
                                </div>
                            </div>
                            <div class="form-group row">
                                <label for="Invoice Supplier" class="col-sm-3 col-form-label">Invoice Supp</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" name="invoiceSupplier" id="invoiceSupplier" value="{{old('invoiceSupplier')}}" placeholder="Invoice Number Sup" />
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-8">
                        <div class="card-body">
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="remark" id="remarks" value="{{old('remark')}}" placeholder="Remarks" />
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" data-placeholder="Select a Product" style="width: 100%;" name="products[]">
                                        <option value=""></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control select2" data-placeholder="Select a supplier" style="width: 100%;" name="suppliers[]">
                                        <option value=""></option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="serialNumber" id="serialNumber" value="{{old('SerialNumber')}}" placeholder="SerialNumber" />
                                </div>
                            </div>
